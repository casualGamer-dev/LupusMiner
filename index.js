...
async function rewardUser() {
    ...
    console.log(chalk.green(`====================[Coins payout]====================`))
    console.log(chalk.greenBright(`You have just earned ${coins} Coins!`))
    console.log(chalk.green(`====================[Coins payout]====================`))
}
...
async function showHelpMessage(killProcess = false) {
    ...
    console.log(chalk.cyan("This is the Coins miner which can be used to earn Coins by cryptomining on your PC!"))
    console.log(chalk.cyan("This miner is being maintained by Toivi"))
    console.log(chalk.cyan("If you find any bugs, please report them to Toivi, reports for major bugs will be rewarded Coins!"))
...
async function run() {
    ...
    console.log(chalk.green(figlet.textSync('Coins GPU Miner')))
    ...
    if (osInfo.platform === 'darwin') return console.log(chalk.green("MacOS support coming soon"))
}
